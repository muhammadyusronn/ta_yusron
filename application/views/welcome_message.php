								...
								<div class="card-body">
									...
									<div class="tab-content">
										<div class="tab-pane fade show active" id="home-1" role="tabpanel" aria-labelledby="home-tab">
											<div class="media">
												<img class="mr-3 w-25 rounded" src="<?= base_url('assets/') ?>images/samples/300x300/13.jpg" alt="sample image">
										...
										<div class="tab-pane fade" id="profile-1" role="tabpanel" aria-labelledby="profile-tab">
											<div class="media">
												<img class="mr-3 w-25 rounded" src="<?= base_url('assets/') ?>images/faces/face12.jpg" alt="sample image">
												<div class="media-body">
											...
											<div class="tab-content tab-content-vertical">
												<div class="tab-pane fade show active" id="home-2" role="tabpanel" aria-labelledby="home-tab-vertical">
													<div class="text-center">
														<img class="mr-3 w-25 mb-4" src="<?= base_url('assets/') ?>images/samples/300X300/12.html" alt="sample image">
													</div>
													<p>
												...
												<div class="tab-pane fade" id="profile-2" role="tabpanel" aria-labelledby="profile-tab-vertical">
													<div class="text-center">
														<img class="mb-3 w-25 rounded" src="<?= base_url('assets/') ?>images/faces/face1.jpg" alt="sample image">
											...
											<div class="tab-content tab-content-vertical tab-content-vertical-custom">
												<div class="tab-pane fade show active" id="home-3" role="tabpanel" aria-labelledby="home-tab-custom">
													...
													<div class="d-flex mt-4">
														<img src="<?= base_url('assets/') ?>images/samples/300x300/3.jpg" class="w-25 h-100 rounded" alt="image" />
														<img src="<?= base_url('assets/') ?>images/samples/300x300/4.jpg" class="w-25 h-100 ml-2 rounded" alt="image" />
													</div>
													<p class="mt-4">
												...
												<div class="tab-pane fade" id="profile-3" role="tabpanel" aria-labelledby="profile-tab-custom">
													<div class="media">
														<img class="align-self-center mr-3 w-25 rounded" src="<?= base_url('assets/') ?>images/samples/300x300/15.jpg" alt="sample image">
														<div class="media-body">
															<p>
												...
												<div class="tab-pane fade" id="contact-3" role="tabpanel" aria-labelledby="contact-tab-custom">
													<div class="media">
														...
														<img class="ml-3 w-25" src="<?= base_url('assets/') ?>images/samples/300x300/5.jpg" alt="sample image">
													</div>
												</div>
											</div>
										</div>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="pills-tabContent">
										<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
											<div class="media">
												<img class="mr-3 w-25 rounded" src="<?= base_url('assets/') ?>images/samples/300x300/12.jpg" alt="sample image">
												<div class="media-body">
										...
										<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
											<div class="media">
												<img class="mr-3 w-25 rounded" src="<?= base_url('assets/') ?>images/samples/300X300/10.html" alt="sample image">
												<div class="media-body">
