...
<!-- Mirrored from www.bootstrapdash.com/demo/justdo/template/demo/horizontal-default-light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 May 2021 13:15:12 GMT -->
...
<head>
	...
	<!-- plugins:css -->
	<script defer src="<?= base_url('assets/node_modules/@fortawesome/fontawesome-free/js/brands.js') ?>"></script>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
										...
										<i class="fas fa-book-open icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
									</div>
...
<!-- Mirrored from www.bootstrapdash.com/demo/justdo/template/demo/horizontal-default-light/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 May 2021 13:15:37 GMT -->
